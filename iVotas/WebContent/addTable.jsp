...
<center>
	...
	<h1>
		<span class="label label-default">Adicionar Mesa de Voto</span>
	</h1>
<br><br>


	
	<s:form action="addTable">
		...
		<strong>	<s:text name="Username" /> </strong>
			<br>
			<s:textfield name="username" cssClass="form-control input-sm" />
			<s:fielderror cssClass="alert alert-danger actionError"
				fieldName="username" />
		</div>
		<div class="form-group col-lg-2">
		<strong>	<s:text name="Password:" /></strong>
			<br>
