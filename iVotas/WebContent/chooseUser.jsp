...
<body>
	...
	<center>	
			<h1>Escolha o Utilizador a Editar</h1>
		<br>
		<br>
	<s:form action="chooseUser" namespace="/">
		<div class="form-group col-lg-2">
			<s:action name="Usernames">
			</s:action>
			<s:select cssClass="form-control" name="user"
				list="#attr.users"></s:select>
		</div>
