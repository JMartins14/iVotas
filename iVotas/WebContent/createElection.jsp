...
<title>iVotas - Criar Eleição</title>
</head>
<body>
	...
	<s:form action="createElection" namespace="/">
		<div class="form-group col-lg-2">
		<strong>	<label for="title">Titulo da Eleição</label> </strong>
			<s:textfield name="electionTitle" cssClass="form-control input-sm" />
			<s:fielderror cssClass="alert alert-danger actionError"
				fieldName="title" />
		</div>
		<div class="form-group col-lg-3">
			<strong><label for="type">Categoria</label> </strong><br>
			<s:radio id="nucleoestudantes" name="category"
				list="#{'1' : ' Nucleo de Estudantes'}"></s:radio>
			<br>
			<s:radio id="conselhogeral" name="category"
				list="#{'2' : ' Conselho Geral'}"></s:radio>
			<br>
			<s:fielderror cssClass="alert alert-danger actionError"
				fieldName="category" />
		...
		<div class="form-group col-lg-4">
			...
			<s:select cssClass="form-control col-lg-4" name="department"
				list="#attr.categories"></s:select>
		</div>
		<div class="form-group col-lg-4">
			<strong><label for="comment">Descrição</label></strong>
			<s:textarea name="description" rows="5"
				cssClass="form-control input-sm"></s:textarea>
			<s:fielderror cssClass="alert alert-danger actionError"
				fieldName="description" />

		</div>
		<div class="form-group col-lg-4">
			<strong><label for="begindate">Data de Início da Eleição</label></strong>
			<s:textfield name="begindate" placeholder="dd/mm/yyyy-hh:mm"
		...
		<div class="form-group col-lg-4">
			<strong><label for="enddate">Data de Fim da Eleição</label></strong>
			<s:textfield name="enddate" placeholder="dd/mm/yyyy-hh:mm"
				cssClass="form-control input-sm"></s:textfield>
			<s:fielderror cssClass="alert alert-danger actionError"
				fieldName="enddate" />

		</div>
		<s:submit cssClass="btn btn-primary btn-md" value="Criar"></s:submit>
	</s:form>
	<br>
