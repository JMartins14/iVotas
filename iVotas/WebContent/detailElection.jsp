...
<center>
	...
	<s:form action="gotoeditElection" namespace="/">
		<div class="form-group col-lg-2">
			...
			<h5>
				...
				<s:if test="%{#attr.studlistelection.size()>0}">
					<h5>Listas de Estudantes</h5>
					<s:iterator value="#attr.studlistelection">
						<p>
							<s:property />
						</p>
					</s:iterator>
				...
				<s:if test="%{#attr.doclistelection.size()>0}">
					...
					<s:iterator value="#attr.doclistelection">
						<p>
							<s:property />
						</p>
					</s:iterator>
				...
				<s:if test="%{#attr.funclistelection.size()>0}">
					...
					<s:iterator value="#attr.funclistelection">
						<p>
							<s:property />
						</p>
					</s:iterator>
		...
		<s:submit cssClass="btn btn-primary btn-md" value="Editar">
			<s:param name="election" value="#attr.election"></s:param>
