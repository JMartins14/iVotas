...
<title>iVotas - Edição da Eleição</title>
</head>
<body>
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"
	...
	<br>
	<center>
	<h1>Edição da Eleição</h1>
	<s:form action="editElection" namespace="/">
		<div class="form-group col-lg-2">
			<label for="title">Titulo da Eleição</label>
		...
		<div class="form-group col-lg-4">
			<label for="begindate">Data de Início da Eleição</label>
		...
		<div class="form-group col-lg-4">
			<label for="enddate">Data de Fim da Eleição</label>
	...
	<br>
	<s:form action="gotoChooseElection">
