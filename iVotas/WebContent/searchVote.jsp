...
<body><script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"
	...
	<br>
		<center>
			<h1><span class="label label-default">Local de Voto</span></h1>
	<s:form action="searchVote">
		<div class="form-group col-lg-2">

		  <strong><label for="title">Nº de Cartão de Cidadão</label></strong>
		<s:textfield size="60" name="ccnumber" cssClass="form-control input-sm" />
				...
				fieldName="ccnumberError" />
										<s:action name="getElections">
			</s:action>
			<br>
			<br>
			  <strong><label for="title">Eleição</label></strong>
			<s:action name="getElections">
			</s:action>
			<s:select cssClass="form-control" name="electionTitle"
				list="#attr.elections"></s:select>
				<br>
					<s:submit cssClass="btn btn-primary btn-md" value="Procurar"/>
